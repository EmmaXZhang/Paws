  ...
  return (
    <Form className="justify-content-lg-center mt-5" onSubmit={submitHandler}>
      ...
      <Form.Group className="mb-3" as={Col} controlId="state">
        ...
        <Form.Control placeholder="Enter State" value={state} onChange={(e) => setState(e.target.value)} />
      </Form.Group>

      <Form.Group className="mb-3" as={Col} controlId="zip">
        <Form.Label>Zip</Form.Label>
        <Form.Control placeholder="Enter Zip Code" value={zip} onChange={(e) => setZip(e.target.value)} />
      </Form.Group>
